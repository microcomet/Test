...
<html>
	...
	<body>
		...
		<div id="create-image" class="content scaffold-create" role="main">
			...
			<g:uploadForm url="[resource:imageInstance, action:'upload']" >
				<fieldset class="form">
					<g:render template="form"/>
					<div class="fieldcontain ${hasErrors(bean: imageInstance, field: 'image', 'error')} required">
						<label for="myfile">
							<g:message code="image.image.label" default="Name" />
							<span class="required-indicator">*</span>
						</label>
                        %{--<input name="myfile" type="file" />--}%
						<g:field name="myfile" type="file" multiple="multiple" value="${imageInstance?.myfile}" />
					</div>
				</fieldset>
			...
			<g:uploadForm url="[resource:imageInstance, action:'uploadMultiImages']" >
				<fieldset class="form">
					<g:render template="form"/>
					<div class="fieldcontain ${hasErrors(bean: imageInstance, field: 'image', 'error')} required">
						<label for="files">
						...
						<g:field name="files" type="file" multiple="multiple" value="${imageInstance?.files}" />
					</div>
				</fieldset>
				<fieldset class="buttons">
					<g:submitButton name="create" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" />
