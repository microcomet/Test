...
<html>
				...
				<div class="span12">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<g:form url="[resource:serviceItemInstance, action:'save']" class="form-horizontal">
	...
	%{--<a href="#create-serviceItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		%{--<div id="create-serviceItem" class="content scaffold-create" role="main">--}%
			...
			%{--</ul>--}%
			%{--</g:hasErrors>--}%
			%{--<g:form url="[resource:serviceItemInstance, action:'save']" >--}%
				%{--<fieldset class="form">--}%
					%{--<g:render template="form"/>--}%
				%{--</fieldset>--}%
