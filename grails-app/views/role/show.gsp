	...
	<body>
		...
		<div id="show-role" class="content scaffold-show" role="main">
			...
			<ol class="property-list role">
				...
				<g:if test="${roleInstance?.create_time}">
				<li class="fieldcontain">
					<span id="create_time-label" class="property-label"><g:message code="role.create_time.label" default="Createtime" /></span>
					
						<span class="property-value" aria-labelledby="create_time-label"><g:formatDate date="${roleInstance?.create_time}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${roleInstance?.update_time}">
				<li class="fieldcontain">
					<span id="update_time-label" class="property-label"><g:message code="role.update_time.label" default="Updatetime" /></span>
					
						<span class="property-value" aria-labelledby="update_time-label"><g:formatDate date="${roleInstance?.update_time}" /></span>
