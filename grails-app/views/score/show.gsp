	...
	<body>
		...
		<div id="show-score" class="content scaffold-show" role="main">
			...
			<ol class="property-list score">
				...
				<g:if test="${scoreInstance?.name}">
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="score.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${scoreInstance}" field="name"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${scoreInstance?.type}">
				<li class="fieldcontain">
					<span id="type-label" class="property-label"><g:message code="score.type.label" default="Type" /></span>
					
						<span class="property-value" aria-labelledby="type-label"><g:fieldValue bean="${scoreInstance}" field="type"/></span>
