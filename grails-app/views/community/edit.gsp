	...
	<div id="content">
		<div id="content-header">
			<div id="breadcrumb">
				...
				<a href="<g:createLink controller="community" action="index" id="${sid}"/>" class="current">社区管理</a>
				<a href="#" class="current">修改社区</a>
			</div>
			%{--<h1>Tables</h1>--}%
				...
				<div class="span12">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<g:form url="[resource:communityInstance, action:'update']" class="form-horizontal">
		...
		%{--<div id="edit-community" class="content scaffold-edit" role="main">--}%
			...
			%{--</ul>--}%
			%{--</g:hasErrors>--}%
			%{--<g:form url="[resource:communityInstance, action:'update']" method="PUT" >--}%
