...
<html>
	...
	<div id="content">
				...
				<div class="span12">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<g:form url="[resource:streetInstance, action:'update']" class="form-horizontal">
		...
		%{--<a href="#edit-street" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		%{--<div class="nav" role="navigation">--}%
			...
			%{--</ul>--}%
		%{--</div>--}%
		%{--<div id="edit-street" class="content scaffold-edit" role="main">--}%
			...
			%{--</ul>--}%
			%{--</g:hasErrors>--}%
			%{--<g:form url="[resource:streetInstance, action:'update']" method="PUT" >--}%
