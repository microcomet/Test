...
<script>
				...
				<div class="span12">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<g:form url="[resource:streetInstance, action:'save']" class="form-horizontal" onsubmit="if(formcheck()){return true;}else{return false;}">
	...
	%{--<a href="#create-street" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
		...
		%{--<div id="create-street" class="content scaffold-create" role="main">--}%
			...
			%{--</ul>--}%
			%{--</g:hasErrors>--}%
			%{--<g:form url="[resource:streetInstance, action:'save']" >--}%
				%{--<fieldset class="form">--}%
					%{--<g:render template="form"/>--}%
				%{--</fieldset>--}%
